...
class HoughLineCornerDetector:
    ...
    #     Horizontal lines
        ...
        #         theta = lines[i][0][1]
        #         angle = np.rad2deg(theta)
        #         if rho==min_v or rho==max_v or rho ==min_h or rho==max_h:
        #             extreme_lines.append(lines[i])
    ...
    def _get_intersections(self):
        ...
        for i, j in group_lines:
            ...
            if 75.0 < self._get_angle_between_lines(line_i, line_j) < 105.0:
